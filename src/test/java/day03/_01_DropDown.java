...
//        1. LOCATE dropdown element
        WebElement year = driver.findElement(xpath("//select[@id='year']"));
...
//      Ay Secimi
        WebElement ay = driver.findElement(xpath("//select[@id='month']"));
...
//        Gun secimi selectByVisibleTest
        WebElement gun = driver.findElement(id("day"));
...
//        Tum eyalet isimlerini consola yazdiralim
        WebElement state = driver.findElement(xpath("//select[@id='state']"));
...
//        String varsayilanElementText = varsayilanElement.getText();
        ...
        System.out.println(varsayilanText);
